...
- `UserSettingsReconciliation.Tests.ps1` — safe three-way reconciliation of installed and VM Utilities `UserGame.ini`/`UserEngine.ini` copies, including first-run conflicts, exact content preservation, transactional backups, rollback, and verified deployment.
